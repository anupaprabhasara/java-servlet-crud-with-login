                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <img class="h-10 w-10 rounded-full" 
                                 ...
                                 alt="Profile picture">
                            <span class="ml-3 mr-2 text-white">John Doe</span>
                        </div>
                        <button class="bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 text-white px-4 py-2 rounded-lg transition-all duration-300 shadow-lg">
                            Logout
                        </button>
                    </div>
                </div>
